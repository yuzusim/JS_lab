...
// title.style.color = "blue"; // color 변경
...
// 2) event를 listen 하는 법
// event: 어떤 행위를 하는 것
// HTML 요소를 가져와서 addEventListener function을 실행시켜 주면 됨
...
// function이 js에게 넘겨주고 유저가 title을 click할 경우에 js가 실행버튼을 대신 눌러주길 바라는 것임
